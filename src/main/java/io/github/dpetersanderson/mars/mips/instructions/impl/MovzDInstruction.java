...
public class MovzDInstruction extends BasicInstruction {
    public MovzDInstruction() {
        super(
                "movz.d $f2,$f4,$t3",
                "Move floating point double precision : If $t3 is zero, set double precision $f2 to double precision"
                        + " value in $f4",
