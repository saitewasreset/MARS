...
public class CLtSInstruction extends BasicInstruction {
    public CLtSInstruction() {
        super(
                "c.lt.s $f0,$f1",
                "Compare less than single precision : If $f0 is less than $f1, set Coprocessor 1 condition flag 0 true"
                        + " else set it false",
