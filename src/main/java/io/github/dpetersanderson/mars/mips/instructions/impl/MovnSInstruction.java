...
public class MovnSInstruction extends BasicInstruction {
    public MovnSInstruction() {
        super(
                "movn.s $f0,$f1,$t3",
                "Move floating point single precision : If $t3 is not zero, set single precision $f0 to single"
