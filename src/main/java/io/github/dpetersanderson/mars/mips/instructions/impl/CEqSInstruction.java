...
public class CEqSInstruction extends BasicInstruction {
    public CEqSInstruction() {
        super(
                "c.eq.s $f0,$f1",
                "Compare equal single precision : If $f0 is equal to $f1, set Coprocessor 1 condition flag 0 true else"
                        + " set it false",
