...
public class CLeD2Instruction extends BasicInstruction {
    public CLeD2Instruction() {
        super(
                "c.le.d 1,$f2,$f4",
                "Compare less or equal double precision : If $f2 is less than or equal to $f4 (double-precision), set"
                        + " Coprocessor 1 condition flag specfied by immediate true else set it false",
