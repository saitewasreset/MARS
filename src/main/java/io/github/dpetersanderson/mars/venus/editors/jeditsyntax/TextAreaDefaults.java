...
package io.github.dpetersanderson.mars.venus.editors.jeditsyntax;
...
public class TextAreaDefaults {
    ...
    public static TextAreaDefaults getDefaults() {
        ...
        DEFAULTS.caretBlinks =
                (io.github.dpetersanderson.mars.Globals.getSettings().getCaretBlinkRate() != 0);
        DEFAULTS.caretBlinkRate =
                io.github.dpetersanderson.mars.Globals.getSettings().getCaretBlinkRate();
        DEFAULTS.tabSize = io.github.dpetersanderson.mars.Globals.getSettings().getEditorTabSize();
        ...
        DEFAULTS.lineHighlight = io.github.dpetersanderson.mars.Globals.getSettings()
