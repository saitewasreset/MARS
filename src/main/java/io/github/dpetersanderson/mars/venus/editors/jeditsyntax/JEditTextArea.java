...
import io.github.dpetersanderson.mars.venus.editors.jeditsyntax.tokenmarker.*;
import java.awt.*;
...
public class JEditTextArea extends JComponent {
    ...
    private void applySyntaxSensitiveHelp() {
        if (!io.github.dpetersanderson.mars.Globals.getSettings()
                .getBooleanSetting(io.github.dpetersanderson.mars.Settings.POPUP_INSTRUCTION_GUIDANCE)) {
            return;
        }
        int line = getCaretLine();
        int lineStart = getLineStartOffset(line);
